...
class MapImage(object):
    def __init__(self, carla_world, carla_map, pixels_per_meter, show_triggers, show_connections, show_spawn_points):
        ...
        self.show_spawn_points = True#show_spawn_points
    ...
    def draw_road_map(self, map_surface, carla_world, carla_map, world_to_pixel, world_to_pixel_width):
        ...
        def draw_spawn_points(surface, color=COLOR_SCARLET_RED_0):
            ...
            for i in range(len(spawn_points)):
                ...
                spawn_point_font_surface = font.render(str(i), False, color)
                spawn_point_font_surface = pygame.transform.scale(
                    spawn_point_font_surface, (spawn_point_font_surface.get_width(), spawn_point_font_surface.get_height() * 2))
                pixel_pos = world_to_pixel(sp.location)
                offset = spawn_point_font_surface.get_rect(center=(pixel_pos[0], pixel_pos[1]))
                surface.blit(spawn_point_font_surface, offset)
